...
Route::get('/download-document/{education_serial}', [DocumentController::class, 'downloadDocument'])->name('download.document');

Route::get('/applicant/photo/{document_id}', [LoginController::class, 'showApplicantPhoto'])->name('showApplicantPhoto');
