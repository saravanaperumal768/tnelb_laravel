            ...
            <div class="row layout-top-spacing">
                ...
                <div id="tabsSimple" class="col-xl-6 col-6 layout-spacing">
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="modal-footer mt-2">
                            <button class="btn btn-success " style="margin-right: 20px;" data-bs-dismiss="modal">Submit/ Close</button>
                            <button class="btn btn-warning " style="margin-right: 20px;" data-bs-dismiss="modal">Return to Supervisor/ Auditor</button>
