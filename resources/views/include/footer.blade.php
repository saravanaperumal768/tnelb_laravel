...
<script>
    ...
    document.querySelector('.widget-content .forward_to_auditor').addEventListener('click', function() {
    Swal.fire({
        position: 'center',
        icon: 'success',
        title: 'Accepted and Moved to Auditor',
...
document.querySelector('.widget-content .forward_to_secretary').addEventListener('click', function() {
    Swal.fire({
        position: 'center',
        icon: 'success',
        title: 'Accepted and Moved to Secretary',
        showConfirmButton: false,
        timer: 1500,
        customClass: {
            title: 'swal-title'
