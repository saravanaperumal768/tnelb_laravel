                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <div class="th-content">License of</div>
                                            </th>
                                            <th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                                <a href="{{ route('applicants_detail', ['applicant_id' => $application->application_id]) }}" style="color:blue;">
                                                    <div class="td-content customer-name " style="color:blue;">
